export const dataStones = [
  {
    id: "1",
    img: "/img/A.png",
    name: "Amethyst",
    chakra: "Sahasrara",
    sternzeichen: "Jungfrau, Schütz, Fische, Widder",
    thema: "Balance, Heilung, Innere Ruhe, Familie, Beziehnung",
    inhalt:
      "In der Meditation wirkt er sich stark auf dein drittes Auge und kann dir den Zugang zur spirituellen Ebene erleichtern. Er reinig die Atmospähre und bringt harmonie in das Familienleben.",
    anwendung:
  ...
  {
    id: "2",
    img: "/img/AngelAura.png",
    name: "Angel Aura",
    chakra: "Sahasrara",
    sternzeichen: "Widder",
    thema: "Heilung, Innere Ruhe",
    inhalt:
  ...
  {
    id: "3",
    img: "/img/aventurin.png",
    name: "Aventurin",
    chakra: "Anahata",
    sternzeichen: "Stier, Krebs, Schütze",
    thema: "Neufang, Balance, Innere Ruhe, Familie, Beziehung",
    inhalt:
  ...
  {
    id: "4",
    img: "/img/Bergkristall.png",
    name: "Bergkristall",
    chakra:
      "Muladhara, Swadisthana, Manipura, Anahata, Vishudda, Ajna, Sahasrara",
    sternzeichen: "Zwilling, Löwe, Steinbock",
    thema: "Neufang, Heilung, Hoffnung",
    inhalt:
  ...
  {
    id: "5",
    img: "/img/CandleQuarz.png",
    name: "Candle Quarz",
    chakra: "Manipura, Anahata, Ajna",
    sternzeichen: "Zwilling, Fische",
    thema: "Heilung, Klarheit, Hoffnung",
    inhalt:
  ...
  },
  {
    ...
    thema: "Schutz, Innere Ruhe, Klarheit",
    inhalt:
  ...
  {
    id: "7",
    img: "/img/Fluorite.png",
    name: "Fluorit",
    chakra: "Manipura, Ajna",
    sternzeichen: "Skorpion, Wassermann, Fische",
    thema: "Schwangerschaft, Konzentration, Beziehung ",
    inhalt:
      "Alle Fluorite können inspirierend wirken und unsere Intuition und Konzentration stärken. Sie sind daher perfekt geeignet für alle, die geistige Arbeit leisten, in der Schule oder im Büro. Gerade in Prüfungssituationen kann ein Fluorit uns  helfen, indem er uns die Prüfungsangst nimmt  und uns hilft, uns zu fokussieren.Der Fluorit hilft jedoch nicht nur dabei, unsere  innere Ordnung zu finden, sondern öffnet uns auch für Liebe und Freundschaft. In der Meditation kann er dabei helfen, uns weit zu öffnen und Wärme und Ruhe zu empfinden.",
    anwendung:
      "Trage deinen Fluorit direkt auf der Haut, um von seiner Wirkung zu profitieren. Erfahre seine geistige Wirkung, indem du ihn in einem ruhigen  Moment betrachtest. ",
    status: false,
  },
  {
    id: "8",
    ...
    chakra: "Sahasrara",
    sternzeichen: "Fische",
    thema: "Lebensfreude, Aufbruch, Neuanfang, Klarheit ",
    inhalt:
  ...
  },
  {
    ...
    img: "/img/Granat.png",
    name: "Granat",
    chakra: "Swadisthana, Manipura, Anahata, Vishudda, Ajna, Sahasrara",
    sternzeichen: "Widder, Skorpion, Fisch",
  ...
  },
  {
    ...
    name: "Hämatit",
    chakra: "Muladhara",
    sternzeichen: "Widder, Jungfrau, Skorpion, Wassermann",
    thema: "Lebensfreude, Innere Ruhe",
    inhalt:
  ...
  {
    id: "11",
    img: "/img/Heliotrop.png",
    name: "Heliotrop",
    chakra: "Manipura, Anahata",
    sternzeichen: "Jungfrau, Waage",
    thema: "Lebensfreude, Schutz, Konzentration, Balance, Innere Ruhe ",
    inhalt:
  ...
  },
  {
    ...
    chakra: "Anahata",
    sternzeichen: "Krebs",
    thema: "Lebensfreude, Schwangerschaft, Innere Ruhe, Familie, Beziehung ",
    inhalt:
  ...
  {
    id: "13",
    img: "/img/Kirschblütenachat.png",
    name: "Kirschblütenachat",
    chakra: "Anahata, Manipura",
    sternzeichen: "Stier, Skorpion, Steinbock, Fische",
    thema: "Herzöffnung, Neuanfang",
    inhalt:
  ...
  {
    id: "14",
    img: "/img/Labradorit.png",
    name: "Labradorit",
    chakra:
      "Manipura, Anahata, Muladhara, Swadisthana, Manipura, Vishudda, Ajna, Sahasrara",
    sternzeichen: "Stier, Krebs, Wassermann",
    thema: "Aufbruch Balance, Familie, Beziehung ",
    inhalt:
  ...
  {
    id: "15",
    img: "/img/Mondstein.png",
    name: "Mondstein",
    chakra: "Swadisthana, Vishudda",
    sternzeichen: "Krebs, Schütze, Wassermann, Fische ",
    thema: "Aufbruch Balance, Familie, Beziehung ",
    inhalt:
